...
; that is efficient for both sparse adn dense polynomials.
; One way to do this is to allow both kinds of term-list representations
; in our system. The situation is analogous to the complex-number 
...
; and make the operations on term lists generic. Redesign the polynomial
; system to implement this generalization. This is a major effort, not a local
; change.
